...
public abstract class AbstractCommandBasedOperatingSystem implements IOperatingSystem {
  ...
  /** The system 2 charset properties filename. */
  private final String system2CharsetPropertiesFilename;
   ...
   * @param command
   *          the command
   * @param system2CharsetPropertiesFilename
   *          the system 2 charset properties filename
   */
  protected AbstractCommandBasedOperatingSystem(
      String operatingSystemNameMarker,
      List<String> command, String system2CharsetPropertiesFilename) {
    this.operatingSystemNameMarker = operatingSystemNameMarker;
    this.command = command;
    this.system2CharsetPropertiesFilename = system2CharsetPropertiesFilename;
  }
  ...
  private String systemToCharsetName(String systemName) {
    try (InputStream systemName2JavaInputStream = getClass()
        .getResourceAsStream(system2CharsetPropertiesFilename)) {
